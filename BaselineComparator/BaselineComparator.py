...
import shutil
import os.path
from Libraries.Common.BaselineComparator.html_baseline import HTMLBaseline
from Libraries.Common.BaselineComparator.table_parser import TableParser
from Libraries.Common.BaselineComparator.json_comparator import CMF_baseline_compare, compare_jsons
from Libraries.Common.BaselineComparator.xml_comparator import compare_xml,sort_xml
...
class BaselineComparator(object):
    ...
    def mx_compare_csv_files(self, baseline_file, app_file, delimiter=',', skip_columns_names=None,
        ...
        | Mx Compare Csv Files | ${CURDIR}\\\\baseline.csv  | ${CURDIR}\\\\app.csv |
        | Mx Compare Csv Files | ${CURDIR}\\\\baseline.csv  | ${CURDIR}\\\\app.csv | delimiter=';' |

        To use skip columns or sort functionalities passing list arguments is required.
        | Mx Compare Csv Files | ${CURDIR}/baseline_key_column.csv | ${CURDIR}/app_key_column.csv | sort_columns_names=@{Sort Colums} |
        | Mx Compare Csv Files | ${CURDIR}/baseline_key_column.csv | ${CURDIR}/app_key_column.csv | skip_columns_names=@{Skip Colums} |
        | Mx Compare Csv Files | ${CURDIR}/baseline_key_column.csv | ${CURDIR}/app_key_column.csv | key_columns_names=@{Key Colums} |
        | Mx Compare Csv Files | ${CURDIR}/baseline_key_column.csv | ${CURDIR}/app_key_column.csv | skip_columns_names=@{Skip Colums} | sort_column_names=@{Sort Colums} |
        | Mx Compare Csv Files | ${CURDIR}/baseline_key_column.csv | ${CURDIR}/app_key_column.csv | skip_columns_names=@{Skip Colums} | sort_column_names=@{Sort Colums} |
        ...
        | Mx Compare Csv Files | ${CURDIR}\\\\baseline.csv  | ${CURDIR}\\\\app.csv |  delete_files=True  |
    ...
    def mx_compare_xls_files(self, app_file, baseline_file, app_sheet=None, baseline_sheet=None,
        ...
        """
                ...
                |Arguments|
                 ...
                 | Mx Compare Xls Files | D:/testExcel/appfile.xls | D:/testExcel/baselinefile.xls |

                 2. Compare two xlsx files.
                 | Mx Compare Xls Files | D:/testExcel/appfile.xlsx | D:/testExcel/baselinefile.xlsx |

                 3. Compare xls file with xlsx file.
                 | Mx Compare Xls Files | D:/testExcel/appfile.xls | D:/testExcel/baselinefile.xlsx |

                 4. Compare two xlsx files with sheet names.
                 | Mx Compare Xls Files | D:/testExcel/appfile.xlsx | D:/testExcel/baselinefile.xlsx | app_sheet=appsheet | baseline_sheet=baselinesheet |

                 5. Compare two xlsx files with Sorting the data.
                 | Mx Compare Xls Files | D:/testExcel/appfile.xlsx | D:/testExcel/baselinefile.xlsx | app_sheet=appsheet | baseline_sheet=baselinesheet | sort_data_in_file= True |
                 ...
                 *** Variables ***
                 ...
                 | ***TestCases*** |
                 | Mx Compare Xls Files | D:/testExcel/appfile.xlsx | D:/testExcel/baselinefile.xlsx | skip_columns_names=${SkipColumns} |
                 ...
                 *** Variables ***
                 ...
                 | ***TestCases*** |
                 | Mx Compare Xls Files | D:/testExcel/appfile.xlsx | D:/testExcel/baselinefile.xlsx | app_sheet=appsheet | baseline_sheet=baselinesheet | skip_columns_names=${SkipColumns} |
        """
        ...
        if sort_data_in_file:
            self._mx_sort_xls_file(filepath=app_file, outputpath=app_file_outputpath, sheetname=app_sheet)
            self._mx_sort_xls_file(filepath=baseline_file, outputpath=baseline_file_outputpath, sheetname=baseline_sheet)
        html_manager = HTMLBaseline()
    ...
    def mx_compare_json_data(self, data1, data2, output_file=None, is_data1_file=False, is_data2_file=False, ignored_keys=None,
    ...
    def mx_compare_json_with_baseline_file(self, json_baseline_file, json_data, ignored_keys=None, nb_of_valid_decimal_places=100, nb_of_digit_after_decimal=0, wild_card=None):
        """
    ...
    def mx_json_inner_list_sort(self, json_file, key_to_sort_by, *path_to_list):
        """
        Sorting a list by a 'key_to_sort_by'. path_to_the list in the 'json_file' should be given as a list.
        Example of usage:
        | ${sorted_out} | Mx json inner list sort | unsorted.json | attributes | rows |
        """
    ...
    def mx_compare_xml_with_baseline_file(self, baselinexml, responsexml, ignored_keys=None, nb_of_valid_decimal_places=100):
        """
    ...
    def mx_xml_sort(self, unsortedxml, sortedxml ,sort_key_tag=None,root_xpath=None,reverse=False):
        """
    ...
    def mx_list_baseline_comparator(self, locator, baseline_filepath):
        """| Usage |
        ...
        BaselineComparator().mx_compare_json_data(jstr, baseline_data)

    def _mx_sort_xls_file(self, filepath, outputpath, sheetname=None):
